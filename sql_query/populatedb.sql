...
INSERT INTO GEODB.ITEM(IDCAT,ID,"NAME",LOGO, NOTE, PRICE)
VALUES (1,DEFAULT,'wurstel','c:\docs\DB_photos\wurstel.png' ,'pasta',0.99),
       (2,DEFAULT,'chicken','c:\docs\DB_photos\chicken.png','sdflkje',4.59),
       (3,DEFAULT,'horse','c:\docs\DB_photos\horse.png','sdflkj',1518),
       (1,DEFAULT,'cow','c:\docs\DB_photos\cow.png','fdsjlh',1232),
       (1,DEFAULT,'beef','c:\docs\DB_photos\beef.png','lkdsfgj',15),
       (1,DEFAULT,'pork','c:\docs\DB_photos\pork.png','orkewjl',1231),
       (1,DEFAULT,'ribs','c:\docs\DB_photos\ribs.png','ewlrjk',1232),
       (1,DEFAULT,'sausage','c:\docs\DB_photos\sausage.png','reuirre',2),
       (2,DEFAULT,'caciotta','c:\docs\DB_photos\caciotta.png','qwerty',11.99),
       (2,DEFAULT,'yogurt','c:\docs\DB_photos\yogurt.png', 'sdfghj',1.22),
       (2,DEFAULT,'cheese','c:\docs\DB_photos\cheese.png', 'sdfghj',3.49),  
       (3,DEFAULT,'carrot','c:\docs\DB_photos\carrot.png', 'sdfghj',0.50),
       (3,DEFAULT,'pickle','c:\docs\DB_photos\pickle.png', 'sdfghj',1),
       (3,DEFAULT,'salad','c:\docs\DB_photos\salad.png', 'sdfghj',1.50),
       (3,DEFAULT,'spinach','c:\docs\DB_photos\spinach.png', 'sdfghj',2.00),
       (3,DEFAULT,'potato','c:\docs\DB_photos\potato.png', 'sdfghj',0.50),
       (3,DEFAULT,'tomato','c:\docs\DB_photos\tomato.png', 'sdfghjekrf',0.59),
       (4,DEFAULT,'apple','c:\docs\DB_photos\apple.png', 'texyckv',0.56),
       (4,DEFAULT,'lemon','c:\docs\DB_photos\lemon.png', 'texyckv',0.32),
       (4,DEFAULT,'orange','c:\docs\DB_photos\orange.png', 'texyckv',0.34),
       (4,DEFAULT,'mandarin','c:\docs\DB_photos\mandarin.png', 'texyckv',0.32),
       (4,DEFAULT,'pear','c:\docs\DB_photos\pear.png', 'texyckv',0.21),
       (4,DEFAULT,'strawberry','c:\docs\DB_photos\strawberry.png', 'texyckv',0.56),
       (4,DEFAULT,'raspberry','c:\docs\DB_photos\raspberry.png', 'texyckv',0.65),
       (4,DEFAULT,'banana','c:\docs\DB_photos\banana.png', 'lieuwhf',0.59),
       (5,DEFAULT,'pizza','c:\docs\DB_photos\pizza.png', 'fieguwkh',0.69),              
       (5,DEFAULT,'breadsticks','c:\docs\DB_photos\breadsticks.png', 'feluakh',1.00),
       (5,DEFAULT,'bread','c:\docs\DB_photos\bread.png', 'feluakh',1.00),
       (5,DEFAULT,'ciabatt','c:\docs\DB_photos\ciabatt.png', 'feluakh',1.00),
       (5,DEFAULT,'cracker','c:\docs\DB_photos\cracker.png', 'feluakh',1.00),
       (5,DEFAULT,'flour','c:\docs\DB_photos\flour.png', 'feluakh',1.00),
       (5,DEFAULT,'piada','c:\docs\DB_photos\piada.png', 'feluakh',1.00),
       (5,DEFAULT,'piadina','c:\docs\DB_photos\piadina.png', 'feluakh',1.00),
       (5,DEFAULT,'burrito','c:\docs\DB_photos\burrito.png', 'feluakh',1.00),
       (5,DEFAULT,'paella','c:\docs\DB_photos\paella.png', 'feluakh',1.00); 
